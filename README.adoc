...
image:https://github.com/nurkiewicz/polski-w-it/actions/workflows/python-package.yml/badge.svg[https://github.com/nurkiewicz/polski-w-it/actions/workflows/python-package.yml]
