image:https://github.com/nurkiewicz/polski-w-it/actions/workflows/python-pytest.yml/badge.svg[https://github.com/nurkiewicz/polski-w-it/actions/workflows/python-pytest.yml]
